...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.sleep = exports.concurrencyRun = exports.gfetch = exports.rm = exports.cosCompare = exports.ggetHtmlDOM = exports.ggetHtmlText = exports.getHtmlDOM = exports.getHtmlText = exports.cleanDOM = void 0;
const main_1 = __webpack_require__(519);
class CleanerClass {
    constructor(imgMode) {
...
function getHtmlText(url, charset) {
    return __awaiter(this, void 0, void 0, function* () {
...
function ggetHtmlText(url, charset) {
    return __awaiter(this, void 0, void 0, function* () {
        if (charset === undefined) {
...
function ggetHtmlDOM(url, charset) {
    return __awaiter(this, void 0, void 0, function* () {
        const htmlText = yield ggetHtmlText(url, charset);
        return new DOMParser().parseFromString(htmlText, "text/html");
    });
}
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return this.chapterParse(this.chapterUrl, this.chapterName, this.isVIP, this.isPaid, this.charset)
                ...
                if (this.status !== Status.failed && this.retryTime < rules_1.retryLimit) {
                    yield lib_1.sleep(this.retryTime * 1500);
                    return this.parse();
                }
                else {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.c226ks = exports.gebiqu = exports.dingdiann = exports.shuquge = exports.biquwo = void 0;
const main_1 = __webpack_require__(519);
const lib_1 = __webpack_require__(563);
class biquwo {
    constructor() {
...
class meegoq {
    ...
    bookParse(chapterParse) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const dom = yield lib_1.getHtmlDOM(bookUrl, "GBK");
...
class qidian {
    ...
    chapterParse(chapterUrl, chapterName, isVIP, isPaid, charset) {
        return __awaiter(this, void 0, void 0, function* () {
            function publicChapter() {
                return __awaiter(this, void 0, void 0, function* () {
                    const dom = yield lib_1.ggetHtmlDOM(chapterUrl, charset);
            ...
            function vipChapter() {
                ...
                return __awaiter(this, void 0, void 0, function* () {
                    ...
                    if (isPaid) {
                        const chapterInfo = yield getChapterInfo();
    ...
    chapterParse(chapterUrl, chapterName, isVIP, isPaid, charset) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            function vipChapter() {
                var _a;
                return __awaiter(this, void 0, void 0, function* () {
                    function getvipChapterImage(vipChapterImageUrl, vipChapterName) {
                        return __awaiter(this, void 0, void 0, function* () {
                            let retryTime = 0;
                            ...
                            const vipChapterImageBlob = yield fetchVipChapterImage(vipChapterImageUrl);
                            const vipChapterImage = new main_1.ImageClass(vipChapterImageUrl, vipChapterName, "naive");
                            if (vipChapterImageBlob) {
                                vipChapterImage.imageBlob = vipChapterImageBlob;
                                vipChapterImage.status = main_1.Status.finished;
                            }
                    ...
                    if (isLogin) {
                        ...
                        if (isPaid) {
                            ...
                            if (vipChapterDom) {
                                ...
                                const vipChapterImage = yield getvipChapterImage(vipChapterImageUrl, vipChapterName);
                                const contentImages = [vipChapterImage];
                                const img = document.createElement("img");
                                img.src = vipChapterName;
                                img.alt = vipChapterImageUrl;
