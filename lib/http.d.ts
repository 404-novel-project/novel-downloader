...
export declare function getText(url: string, charset: string | undefined, init?: RequestInit | undefined): Promise<string | void>;
export declare function getHtmlDOM(url: string, charset: string | undefined, init?: RequestInit | undefined): Promise<Document>;
export declare function ggetText(url: string, charset: string | undefined, init?: gfetch_request_options | undefined): Promise<string | void>;
