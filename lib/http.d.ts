...
export declare function getText(input: RequestInfo, charset?: string, init?: RequestInit): Promise<string | void>;
export declare function getHtmlDOM(input: RequestInfo, charset?: string, init?: RequestInit): Promise<Document>;
export declare function getHtmlDomWithRetry(input: RequestInfo, charset?: string, init?: RequestInit): Promise<Document | null>;
