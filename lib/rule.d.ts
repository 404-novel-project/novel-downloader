...
export declare function chapterHiddenFix(book: Book, invalidTest: (c: Chapter) => boolean, getPrevHref: (doc: Document) => string | undefined, concurrencyLimit: number): Promise<void>;
export {};
