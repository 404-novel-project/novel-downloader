...
| 站点                                              | 公共章节 | 付费章节 | 备注                                                                                     |
| ------------------------------------------------- | -------- | -------- | ---------------------------------------------------------------------------------------- |
| [番茄小说](https://fanqienovel.com/) | ✅       | ✅   |所有章节都需要SVIP账号登录下载，否则会调用第三方API请求。
...
如果你发现下载的小说文档有不正常的字符出现，可以打开设置-测试视图后点击日志或者按下F12启用开发者选项了解是否有提示字体匹配操作的信息，它们一般以“[jjwxc-font]”或者“[fanxie-font]”为开头。
