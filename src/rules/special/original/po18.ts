...
export class po18 extends BaseRuleClass {
  ...
  public async bookParse() {
    ...
    const introDom = document.querySelector("div.B_I_content") as HTMLElement;
    ...
    const listUrls = new Set(
      Array.from(dom.querySelectorAll("div.pagenum a")).map(
    ...
    for (const url of listUrls) {
      ...
      for (const aElem of Array.from(cos)) {
        ...
        const Elemb = aElem.querySelector("div.l_btn a") as HTMLAnchorElement;
